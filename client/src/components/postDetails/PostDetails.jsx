...
const PostDetails = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        const res = await fetch(`https://social-media-psi-nine.vercel.app/post/find/${id}`)
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        const res = await fetch(`https://social-media-psi-nine.vercel.app/comment/${id}`, {
          headers: {
    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        <div className={classes.left}>
          <img src={post?.photo && `https://social-media-psi-nine.vercel.app/images/${post?.photo}`} />
        </div>
