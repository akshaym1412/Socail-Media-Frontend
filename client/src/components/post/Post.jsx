...
const Post = ({ post }) => {
  ...
  useEffect(() => {
    const fetchComments = async () => {
      try {
        const res = await fetch(`https://social-media-psi-nine.vercel.app/comment/${post._id}`, {
          headers: {
  ...
  const deletePost = async () => {
    try {
      await fetch(`https://social-media-psi-nine.vercel.app/post/${post._id}`, {
        headers: {
          "Authorization": `Bearer ${token}`
        },
        method: 'DELETE'
  ...
  const handleLikePost = async () => {
    try {
      await fetch(`https://social-media-psi-nine.vercel.app/post/toggleLike/${post._id}`, {
        headers: {
          "Authorization": `Bearer ${token}`
        },
        method: "PUT"
  ...
  const handleBookmark = async () => {
    try {
      await fetch(`https://social-media-psi-nine.vercel.app/user/bookmark/${post._id}`, {
        headers: {
          "Authorization": `Bearer ${token}`
        },
        method: "PUT"
  ...
  const handlePostComment = async () => {
    ...
    try {
      const res = await fetch(`https://social-media-psi-nine.vercel.app/comment`, {
        headers: {
    ...
    <div className={classes.container}>
      <div className={classes.wrapper}>
        ...
        <div className={classes.center}>
          ...
          <img className={classes.postImg} src={post?.photo ? `https://social-media-psi-nine.vercel.app/images/${post?.photo}` : woman} />
        </div>
